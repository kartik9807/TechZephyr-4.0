...
export default function Home() {
  ...
  /* =========================================================
      PLAY CINEMATIC INTRO ONLY ON FIRST ENTRY
      ...
      Refresh during same browser session
      ❌ Intro does NOT play again.

      New browser session
      ✅ Intro can play again.
  ========================================================== */

  useEffect(() => {
    try {
      const hasSeenIntro = sessionStorage.getItem(
        "techzephyr_cinematic_intro_seen"
      );
      ...
      // If sessionStorage is unavailable, still allow the intro once.
      setShowIntro(true);
    }
  ...
  /* =========================================================
      ...
      Reduced from 6 seconds → 5 seconds.
  ========================================================== */
  ...
  /* =========================================================
      ...
      Cinematic opening logic remains unchanged.
  ========================================================== */

  useEffect(() => {
    if (!showIntro || progress < 100) return;
  ...
  /* =========================================================
      PREVENT MAIN CONTENT FLASH BEFORE INTRO CHECK
  ========================================================== */
    ...
    <>
      ...
      {showIntro && (
        <div className="fixed inset-0 z-[9999] overflow-hidden bg-black">
          ...
          {/* Top Light */}
          <div className="pointer-events-none absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-amber-400/[0.025] to-transparent" />

          {/* Bottom Light */}
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-amber-400/[0.025] to-transparent" />
          ...
          >
            ...
            <div className="flex items-center justify-center gap-5 sm:gap-8 md:gap-10">
              ...
              <motion.div
                ...
                className="h-12 w-px origin-center bg-gradient-to-b from-transparent via-white/20 to-transparent sm:h-16"
              />
              ...
              >
                ...
                <img
                  src="https://upload.wikimedia.org/wikipedia/en/8/82/Indian_Institute_of_Technology_Bhubaneswar_Logo.svg"
                  alt="IIT Bhubaneswar"
                  className="relative z-10 h-full w-full object-contain"
                />
              </motion.div>
            ...
            >
              ...
              <div className="relative h-2 w-full overflow-hidden rounded-full bg-white/[0.08]">
                <motion.div
                  className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-yellow-500 via-amber-300 to-yellow-200"
                  animate={{
                    width: `${progress}%`,
                  }}
                  transition={{
          ...
          <motion.div
            ...
            className="absolute left-1/2 top-1/2 z-40 h-full w-px -translate-x-1/2 -translate-y-1/2 bg-gradient-to-b from-transparent via-amber-300 to-transparent"
          />
          ...
          >
            ...
            <div className="absolute inset-y-0 right-0 w-28 bg-gradient-to-l from-amber-400/[0.04] to-transparent" />
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute inset-y-0 right-0 z-20 w-1/2 bg-black"
          >
            <div className="absolute inset-y-0 left-0 w-px bg-gradient-to-b from-transparent via-amber-400/50 to-transparent" />

            <div className="absolute inset-y-0 left-0 w-28 bg-gradient-to-r from-amber-400/[0.04] to-transparent" />
          </motion.div>
        </div>
      )}
      ...
      >
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-4 pb-32 pt-16 sm:px-8 sm:pt-20 lg:px-12">
          ...
          <motion.div
            ...
            className={`mb-5 flex items-center gap-3 text-[9px] uppercase tracking-[0.35em] sm:text-[10px] ${isDark ? "text-zinc-400" : "text-[#7C665A]"
              }`}
          >
          ...
          <motion.p
            ...
            className={`mt-4 text-center text-[10px] uppercase tracking-[0.25em] sm:mt-6 sm:text-xs md:text-sm sm:tracking-[0.35em] ${isDark
                ? "text-zinc-300/70"
                : "text-[#6B3F2A]/80"
              }`}
          >
          ...
          <motion.p
            ...
            className={`mt-5 max-w-2xl text-center text-xs leading-7 sm:text-sm md:text-base ${isDark
                ? "text-zinc-300/75"
                : "text-[#4A4038]/80"
              }`}
          >
          ...
          >
            <a
              href="/Competitions"
              className={`group w-full rounded-xl px-8 py-3.5 text-center text-xs font-semibold uppercase tracking-wide transition-all duration-300 hover:-translate-y-1 sm:w-auto sm:text-sm ${isDark
            ...
            <a
              href="/AboutUs"
              className={`w-full rounded-xl border px-8 py-3.5 text-center text-xs uppercase tracking-wide transition-all duration-300 hover:-translate-y-1 sm:w-auto sm:text-sm ${isDark
                  ? "border-zinc-400/40 text-zinc-100 hover:border-[#D65A45] hover:text-[#F08A72]"
                  : "border-[#6B3F2A]/35 text-[#4A3328] hover:border-[#A44232] hover:text-[#A44232]"
                }`}
            >
          ...
          >
            ...
            <div className="border-b border-r border-black/5 px-5 py-6 text-center dark:border-white/10 sm:border-b-0">
              <div
                className={`text-2xl font-bold sm:text-3xl ${isDark ? "text-white" : "text-[#302722]"
                  }`}
              >
                <CountUp
                  end={10}
              ...
              <div
                className={`mt-1 text-[9px] uppercase tracking-widest sm:text-[10px] ${isDark ? "text-zinc-400" : "text-[#705D52]"
                  }`}
              >
                Events
              </div>
            ...
            <div className="border-r border-black/5 px-5 py-6 text-center dark:border-white/10">
              <div
                className={`text-2xl font-bold sm:text-3xl ${isDark ? "text-[#E8E4E0]" : "text-[#8B3A2E]"
                  }`}
              >
                <CountUp
                  end={10000}
            ...
            <div className="px-5 py-6 text-center">
              <div
                className={`text-2xl font-bold sm:text-3xl ${isDark ? "text-[#F08A72]" : "text-[#9A4A2F]"
                  }`}
              >
                <CountUp
                  end={3.2}
      ...
      <section
        className={`relative border-y px-4 py-9 sm:px-8 ${isDark
            ? "border-white/10 bg-[#0d0b0a]"
            : "border-[#6B3F2A]/10 bg-[#f8f4ee]"
          }`}
      >
        <div className="mx-auto max-w-5xl">
          <div className="mb-7 text-center">
            <p
              className={`text-[9px] uppercase tracking-[0.4em] ${isDark ? "text-zinc-500" : "text-[#806A5E]"
                }`}
            >
              In association with
            </p>
          ...
          <div className="flex items-center justify-center">
            ...
            <div className="flex flex-1 items-center justify-center px-4 sm:px-10">
              <img
                src="/Goibibo.png"
                alt="Goibibo"
                className={`max-h-10 max-w-[120px] object-contain transition-all duration-300 sm:max-h-12 sm:max-w-[160px] ${isDark
            ...
            {/* Divider */}
            <div
              className={`h-10 w-px sm:h-14 ${isDark ? "bg-white/15" : "bg-[#6B3F2A]/15"
                }`}
            />
            ...
            <div className="flex flex-1 items-center justify-center px-4 sm:px-10">
              <img
                ...
                alt="World Technocon"
                className={`max-h-10 max-w-[140px] object-contain transition-all duration-300 sm:max-h-12 sm:max-w-[190px] ${isDark
                    ? "opacity-80 hover:opacity-100"
                    : "opacity-70 hover:opacity-100"
                  }`}
              />
      ...
      <section
        className={`relative overflow-hidden border-t px-4 py-20 sm:px-8 lg:px-16 lg:py-28 ${isDark
      ...
      >
        {/* Background Glow */}
        <div
          className={`pointer-events-none absolute left-1/2 top-20 h-[32rem] w-[32rem] -translate-x-1/2 rounded-full blur-[150px] ${isDark
              ? "bg-red-500/[0.035]"
              : "bg-orange-700/[0.035]"
            }`}
        />
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mx-auto mb-16 max-w-3xl text-center">
            <p
              className={`text-[10px] uppercase tracking-[0.4em] sm:text-xs ${isDark
                  ? "text-[#D65A45]"
                  : "text-[#8B3A2E]"
                }`}
            >
            ...
            <p
              className={`mx-auto mt-5 max-w-2xl text-xs leading-7 sm:text-sm ${isDark
                  ? "text-zinc-400"
                  : "text-[#62554D]"
                }`}
            >
            ...
            {/* Interaction Hint */}
            <div
              className={`mx-auto mt-6 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-[8px] uppercase tracking-[0.25em] ${isDark
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-[2rem] border ${isDark
                  ? "border-white/10 bg-white/[0.025]"
                  : "border-[#6B3F2A]/10 bg-white/60"
                }`}
            >
              <div
                className={`relative aspect-[4/3] overflow-hidden ${isDark
                    ? "bg-black/30"
                    : "bg-[#f1ece4]"
                  }`}
              >
                ...
                <img
                  src="/merch/techzephyr-front.gif"
                  alt="TechZephyr front merchandise interactive preview"
                ...
                {/* Label */}
                <div className="absolute bottom-5 left-5 rounded-full border border-white/20 bg-black/30 px-4 py-2 backdrop-blur-xl">
              ...
              <div className="p-7 sm:p-8">
                <p
                  className={`text-[9px] uppercase tracking-[0.3em] ${isDark
                      ? "text-[#D65A45]"
                      : "text-[#A44232]"
                    }`}
                >
                ...
                <p
                  className={`mt-3 text-xs leading-6 ${isDark
                      ? "text-zinc-400"
                      : "text-[#62554D]"
                    }`}
                >
            ...
            >
              ...
              >
                {/* Replace with your GIF */}
                <img
                  src="/merch/techzephyr-back.gif"
                  alt="TechZephyr back merchandise interactive preview"
                  className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-[1.025]"
                />
          ...
          <motion.div
            ...
            className={`group relative mt-6 overflow-hidden rounded-[2rem] border ${isDark
                ? "border-white/10 bg-white/[0.025]"
                : "border-[#6B3F2A]/10 bg-white/60"
              }`}
          >
            <div className="grid items-center lg:grid-cols-[1.15fr_0.85fr]">
              {/* GIF / Artwork */}
              <div
                className={`relative aspect-[16/10] overflow-hidden lg:aspect-auto lg:h-full ${isDark
                    ? "bg-black/30"
                    : "bg-[#f1ece4]"
                  }`}
              >
                {/* Replace with your GIF */}
                <img
                  src="/merch/techzephyr-design.gif"
                  alt="TechZephyr merchandise artwork interactive preview"
                  className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-[1.025]"
                />
              ...
              <div className="p-8 sm:p-10 lg:p-14">
                ...
                <p
                  className={`mt-5 text-xs leading-7 sm:text-sm ${isDark
                      ? "text-zinc-400"
                      : "text-[#62554D]"
                    }`}
                >
                ...
                <div
                  className={`mt-7 h-px w-16 ${isDark
                      ? "bg-[#D65A45]/40"
                      : "bg-[#A44232]/40"
                    }`}
                />
